 ...
 */
public class StatementHistoryAction
    ...
    public void perform(HttpServlet servlet,
        ...
        StatementHistoryBean history = new StatementHistoryBean();
        history.setAccountNumber(accountId);
        history.setCurrencyPosition(validUser.getCurrencyPosition());
        history.setCurrencySymbol(validUser.getCurrencySymbol());
        history.setProperties(properties);
        history.getResultList();
        ...
        if (error == null) error = history.getErrorMessage();
        String jspName = Util.getCMFile("SSvcStatementHistory.jsp", context);
