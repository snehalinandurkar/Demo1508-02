...
function confirmAutoPayUpdate(){
	document.verifyAutoPayUpdateForm.actionCode.value = "confirmAutoPayUpdate";
	document.verifyAutoPayUpdateForm.submit();
}
...
<body class="wssBody">
<form name="verifyAutoPayUpdateForm">
      					...
      					<table class="wssTableMinor2"> 		            				
            				<tr>
            					<td colspan=4 align=right>
            						...
            						<input type="button" value="Continue" onclick="confirmAutoPayUpdate();" class="button">
            					</td>
            				</tr>          						
	          				</table>
	        			</td>
