...
<%--2011-12-20 - SR0511 - SMedin - Start Add--%>
<jsp:useBean
  id="acctPer"
  scope="request"
  class="com.splwg.selfservice.CMAccountPersonBean">
</jsp:useBean>
<%--2011-12-20 - SR0511 - SMedin - End Add--%>
<jsp:useBean
        		...
        		<table class="wssTableMinor">
	     			<tr>
	      				<td class="wssTD100">
	      					<%--2011-12-20 - SR0511 - SMedin - Start Add--%>
	        				<table width="100%">
	        					<% if (!acctPer.getBillRouteType().equalsIgnoreCase("E-BILL")) {%>
            					<tr>
              						<td width="100%" class="label">
              							<font color=black><strong><jsp:getProperty name="acctPer" property="billRouteMessage" /></strong></font>
              						</td>
            					</tr>
            					<% } %>
							</table>		
	        				...
	        				<table class="wssTableMinor" >
            					<tr class="headerRow">
              						...
              						<td class="wssTDWhiteMidLeft">
              							<font class="wssFontArial2"><jsp:getProperty name="accountInfo" property="accountId" /></font>
              						</td>
            					</tr>
            					<tr class="headerRow">
              						<td class="label">Customer Name</td>
              						<td class="wssTDWhiteMidLeft">
              							<font class="wssFontArial2"><jsp:getProperty name="accountInfo" property="entityName" /></font>
              						</td>
            					</tr>
							</table>
							<tr></tr>
	       					<table class="wssTable650">
	          					<tr class="grid">
	            					...
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="premiseInfo" />&nbsp;</td>
	          					</tr>
	          					<tr class="gridAlt" >
	            					<td class="label">&nbsp;Last Payment</td>
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="lastPayment" />&nbsp;</td>
	          					</tr>
	          					<tr class="grid">
	            					...
	            					<td class="gridTd">
                						<% if (!accountInfo.getLastBill().equals("")) { %>
                    						...
                    						%>
                    							<a href="<%= response.encodeURL("ViewBill") %>?billId=<%= lastBill.getBillId() %>" target="_blank">
                    								<font size="1">View Bill</font>
                    							</a>
                    						<% } %>
                  						<% } %>&nbsp;
                  					</td>
	          					...
	          					<tr class="gridAlt">
	            					...
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="nextBillDate" />&nbsp;</td>
	          					</tr>
	          					<tr class="grid">
	            					<td class="label">&nbsp;Current Balance</td>
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="currentBalance" />&nbsp;</td>
	          					</tr>
	          					<tr class="gridAlt">
	            					<td class="label">&nbsp;<%= SelfService_validUser.getHomePhoneLabel() %></td>
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="homePhone" /></font>&nbsp;</td>
	          					</tr>
	          					<tr class="grid">
	            					<td class="label">&nbsp;<%= SelfService_validUser.getBusinessPhoneLabel() %></td>
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="businessPhone" />&nbsp;</td>
	          					</tr>
	          					<tr class="gridAlt">
	            					<td class="label">&nbsp;E-Mail</td>
	            					<td class="gridTd"><jsp:getProperty name="accountInfo" property="email" />&nbsp;</td>
	          					</tr>
	        				</table>
	      				</td>
	     			</tr>
