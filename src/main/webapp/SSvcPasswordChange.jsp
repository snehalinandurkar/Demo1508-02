<!--*
    ...
    * 2015-06-22  MCerip Security Fix Release 9.
    *
	*-->
              ...
              <td width="496" class=wssTDTopLeft>
                 <table width="100%" class=wssTable0 >
                    ...
                    <tr>
                      ...
                      <td align="left"><font class=wssFontArial2 >
                        <input name="priorPassword" type="password" id="priorPassword" maxLength="12" size="12" value="<%= WebStringUtilities.asHTML(priorPassword) %>">
                        </font></td>
                      <td align="center">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td align="left"><font class=wssFontArial2 >
                        <input name="newPassword" type="password" id="newPassword" size="12" maxLength="12" value="<%= WebStringUtilities.asHTML(newPassword) %>">
                        </font></td>
                      <td >&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="label" align="right">Confirm
                        New Password</td>
                      <td align="left"><font class=wssFontArial2 >
                        <input name="newPasswordConfirm" type="password" id="newPasswordConfirm" maxLength="12" size="12" value="<%= WebStringUtilities.asHTML(newPasswordConfirm) %>">
                        </font></td>
                      <td align="center">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan=4 class=wssTDMidCenter4> <p align="center">
                            <input class="button" type="button" name="Button" value="Change Password" onClick="if(jcap()){ CheckInput(); }else{return false;};">
                        </p></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
