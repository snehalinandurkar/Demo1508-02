...
<title>Interval Data Menu</title>
...
<%=  billPeriodBean.getBillPeriod()%>
<% List<CMBillPeriodBean> list  = billPeriodBean.getBillPeriodList();%>
<%= request.getAttribute("billPeriodList")%>

<%= request.getAttribute("properties")%>
		...
		<table style="" border="0" width="320" align="left" height="" cellspacing="0" cellpadding="0"><!-- here we provide width=320px bcz we take the width same as above (Acct No+Customer Name)-->
			<tr>
				<td style="padding-top: 20px; padding-left: 10px;" class="wssTDMain" valign="middle" align="center" height="40" width="320">
					<b> 
						<font class="wssFontArial5">Interval Data Tabular</font>
					</b>
				</td>
			</tr>
		</table>
						...
						<table style="border-collapse:seperate;border-spacing:0px 2px;" width="350" align="left" height="" cellspacing="0"
							...
							<tr style="">
								...
								<td class="wssTDRightLabel">
									...
									<select name="granularity" style="width:230px;border:none;" class="wssFontArial2"><!-- style="width:220px;border:none; -->
							...
							<tr style="">
								...
								<td class="wssTDRightLabel">
									...
									<select name="granularity" style="width:230px;border:none;" class="wssFontArial2" onChange="updateFromAndToDate()"><!-- style="width:220px;border:none; -->
									<%for(CMBillPeriodBean bean : list){%>
										<option value="<%=bean.getBillPeriodStartDate()%> <%=bean.getBillPeriodEndDate()%>" >
										<span><%=bean.getBillPeriodStartDate()%></span>
										<span><%=bean.getBillPeriodEndDate()%></span>
