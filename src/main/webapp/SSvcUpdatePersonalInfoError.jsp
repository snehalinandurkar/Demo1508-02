          ...
          <table class=wssTableMinor>
            ...
            <tr>
              <td width="501" class=wssTDMidLeft colspan="2"><p align="center"><font class=wssFontArial2
                >Please go
              <a href="<%= response.encodeURL("UpdatePersonalInformation") %>"><b>back</b></a>
              and try again.</font></p></td>
            </tr>
            <tr>
              <td class=wssTDMidLeft>&nbsp;</td>
              <td class=wssTDMidLeft>&nbsp;</td>
...
<td class="wssTDMain"><b><font class="wssFontArial5">Update Personal Information Response</font></b></td>
