<%!
public void CMDisplayMenu(String mnuItem, JspWriter out, HttpServletResponse response){
	...
	try
	{
		...
		mnuList.add(new com.splwg.selfservice.MenuItem("PaymentOptions","Payment Options","PaymentOptions"));
		...
		mnuList.add(new com.splwg.selfservice.MenuItem("CustomerStatement","Customer Statement","CustomerStatement"));
...
public void CMDisplayVDERMenu(String mnuItem, JspWriter out, HttpServletResponse response){
	try
	{
		java.util.LinkedList mnuList = new java.util.LinkedList();
	...
	catch(Exception e)
	{
     ...
     public void CMDisplayReducedMenu(String mnuItem, JspWriter out, HttpServletResponse response) {
        try {
        java.util.LinkedList mnuList = new java.util.LinkedList();
